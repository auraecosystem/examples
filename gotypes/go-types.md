...
package-level type information and syntax trees (though not
type annotations on syntax) for a single package `pkgpath`,
plus types for its dependencies from export data:
