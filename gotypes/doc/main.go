...
func main() {
	...
	// Load syntax and type information for the specified package,
	// using types from export data for dependencies.
	conf := &packages.Config{Mode: packages.NeedTypes | packages.NeedSyntax}
