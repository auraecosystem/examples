...
func main() {
	...
	var (
		toc []tocEntry
		// Keep track of the minimum header depth encountered in the table of
		// contents. If we don't do this, and all the header entries are ## (for
		// example), then the header will be entirely indented, and will format as
		// a code block rather than an outline.
		minTocDepth int
	)
