...
The asymptotically conscious reader will have noticed that our algorithm for
...
by using the result of the value's `String` method,
as our example handler does.
